...
export default function NewClientPage({ params }: { params: Promise<{ workspaceId: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      <div className="max-w-2xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-bold text-stone-900 mb-8">New Client</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-stone-200 rounded-lg p-6 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g., Euronics-like Brand"
            />
          </div>
